...
To create a sticky message, use the `/stickymessage create <message-text> [channel] [embed] [delay] [min-messages]` command. You can view a description of the parameters below:
...
| `embed`         | A saved embed (created in the [Embed Editor](/feature/embed-editor)) to attach to the sticky message. Start typing to search your server's saved embeds. | None          | -       | -       | <span style="background-color: rgb(253, 172, 65); color: black; padding: 3px 7px; font-size: 12px; border-radius: 5px;">Premium Only</span>               |
...
| :--- | :--- | :---: | :---: |
| /stickymessage create | Create a new sticky message. | \<message> [channel] [embed] [delay] [minMessages] | ManageMessages | 
