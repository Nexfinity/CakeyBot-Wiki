...
description: 
published: 1
date: 2023-06-12T05:59:18.690Z
tags: 
editor: markdown
dateCreated: 2022-10-18T07:59:45.134Z
---
...
4. You can then create, delete and edit any commands on this page. You can get an overview of any triggers that are available below. You can also use our [custom placeholders](custom-commands#basic-placeholders) in your commands as well!

> The command trigger will use a custom set prefix if you have changed Cakey Bot's prefix.
{.is-info}

![image.png](/dash/customcmds/image.png)
...
Custom Commands will work with BOTH **Basic Placeholders** & **Advanced Placeholders**. Placeholders can be included in the response section and can modify the behavior/output of the response. You can find the full list of supported placeholders [here](../placeholders).
...
* Triggers
  ...
  * Acceptable values:
    ...
    * 2 - Auto Responders
* Flags
  * These are only used for Auto Responders, they map directly to the Auto Responder [flags](../auto-responder#flags).
  * Acceptable values:
    * 1 - Exact Match
    * 2 - Contains
    * 3 - Starts With
